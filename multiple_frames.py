...
class App(customtkinter.CTk):
    ...
    def btn_add_to_database(self, parent, frame_id):
        """This should be the defualt button that adpats to that frame its on"""
        pass

    # button to select the correct frame
    def frame_selector_bt(self, parent, frame_id):
        """This is the frame selector button that selects the correct frame"""
        # create frame 
